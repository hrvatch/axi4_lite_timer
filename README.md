...
0x2: TIMER0_COMPARE - Timer/Counter0 compare value register
...
0x4: TIMER1_LOAD - Timer/Counter1 load value register
0x5: TIMER1_COMPARE - Timer/Counter1 compare register
```
